...

{
  homebrew = {
    ...
    casks = [
      "1password" "keepassxc"
      "appcleaner" "maccy" "rectangle" "snipaste"
      "brave-browser"
      # "firefox"
      "chatgpt" "thunderbird@esr" "typora"
      "visual-studio-code" "cursor" "fork" "insomnium" "bruno"
      "telegram" "wechat" "wechatwork"
      "localsend" "ddpm" "logi-options+"
      "spotify"
      "vmware-fusion"
    ];
  };
